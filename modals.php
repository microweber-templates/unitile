...
<div class="login-overlay" style="display:none;" id="login-overlay-footer">
  <div class="login-modal-content">
    <span class="lmclose"></span>
    ...
    <div class="login-modal-container">
      <div class="login-modal-content-tabs-holder">
        <div class="lm-left">
          <div class="login-modal-content-tabs-links-holder"> <a href="javascript:;" class="login-modal-tab-link">Login</a> <a href="javascript:;" class="login-modal-tab-link">Register</a> </div>
        ...
        <div class="lm-right">
          <module type="users/login" template="social" />
        </div>
      </div>
    </div>
  </div>
