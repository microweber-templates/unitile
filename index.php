...
<div class="jumbotron sss home-baner">
  <div class="container">
    <div class="row">
      <div class="baner-text edit" rel="page" field="content-home-banner-cont">
    ...
    <div class="mw-row row clearfix">
      <div class="mw-col home-title col-md-12 edit">
        <center>
          ...
          <div class="center">United Group, founded in 1994, is name to reckon within the field of modern Construction & <br />
      ...
      <div class="col-md-4 col-sm-4">
        <div class="mw-col-container">
          <div class="element">
            ...
            <div class="btn-group pull-right"> <a  type="button" class="btn btn-default" href="<?php print site_url('about-us') ?>">View details  &nbsp;&nbsp;&nbsp;<span class="fa fa-chevron-right"></span></a> </div>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="mw-col-container">
          <div class="element">
            ...
            <div class="row">
              <div class="col-sm-4"> <img src="{TEMPLATE_URL}img/whyus.jpg" class="img-responsive"> </div>
  ...
  <div class="container">
    <div class="mw-row row">
      <div class="col-md-6 col-sm-6 right-border">
        ...
        <a href="#"> <img src="{TEMPLATE_URL}img/video.jpg" class="img img-responsive"> </a> </div>
      <div class="col-md-6 col-sm-6">
        <h3>FACTORY UNIT WALKTHROUGH</h3>
        <a href="#"> <img src="{TEMPLATE_URL}img/video2.jpg" class="img img-responsive"> </a> </div>
    </div>
  </div>
</div>
<!-- End Video Layout --> 
  ...
  <div class="container">
    <div class="mw-row">
      <div class="col-md-8 col-sm-8" >
        ...
        <div class="col-sm-12 padding-left-no padding-bottom-30"> <span> <img src="{TEMPLATE_URL}img/proj_1.png" class="img img-responsive" > </span> </div>
      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-sm-12 padding-left-no"> <img src="{TEMPLATE_URL}img/proj_2.png" class="img img-responsive"> </div>
        <div class="col-md-12 col-sm-12" >
        
        
            <module type="pictures" template="cslider" id="cslider_home" />
...
<div class="container edit" id="clients-layout"  rel="page" field="content-clients">
  <div class="container">
    ...
    <module type="pictures" template="xslider" id="xslider_home" />
