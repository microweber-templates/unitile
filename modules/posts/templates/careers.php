...
?>
  ...
  <div class="row module-posts-template-careers-row">
    <?php } ?>
    <div class="col-md-3 career-post-item">
      <?php if($item['link']):  ?>
      ...
      <ul class="career-post-item-reqs">
        ...
        <li class="career-post-item-education"><i class="fa fa-graduation-cap"></i>
 
<?php print $data_fields['education'] ?></li>
        <?php endif; ?>
        <?php if(isset($data_fields['years'])):  ?>
        <li class="career-post-item-years"><i class="fa fa-briefcase"></i>
<?php print $data_fields['years'] ?></li>
        <?php endif; ?>
        <?php if(isset($data_fields['location'])):  ?>
        <li class="career-post-item-location"><i class="fa fa-map-marker"></i>
<?php print $data_fields['location'] ?></li>
        <?php endif; ?>
      </ul>
      <?php endif; ?>
      <a href="<?php print $item['link'] ?>" class="career-post-item-details-link"><span>Details <span class="mw-icon-app-arrow-down"></span></span></a>
